...
class DryRunTest(unittest.TestCase):
    def _run(self, dry_run):
        ...
        with patch("curate.load_raw", return_value=_raw()), \
             ...
             patch.object(objectivity, "update_rank_history") as m_rh:
        ...
        return {
            ...
            "selected_save": m_save.called, "update_rank_history": m_rh.called,
        }
    ...
    def test_dry_run_skips_state_writes(self):
        ...
        self.assertFalse(c["update_rank_history"], "dry-run이 media-rank-history를 저장하면 안 됨")
    ...
    def test_normal_run_persists_state(self):
        ...
        self.assertTrue(c["update_rank_history"])
